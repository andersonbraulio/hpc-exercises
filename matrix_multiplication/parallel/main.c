...
int main(int argc, char **argv) {
    ...
    /* init message passing interface */
    MPI_Init(&argc, &argv);
    ...
    /* identifies the rows of responsability of each process */
    ...
    /* init rows and columns that are of responsibility of each process */
    ...
    /* used to call allgatherv and communicate the cols of B matrix between processes */
    ...
    /* go through B columns and the calculate elements of result matrix */
    ...
    /* used to call gatherv and to send the rows of C matrix to root process */
...
/**
 * get a vector with the number of elements of each process as from possible split
 * @param vector
 * @param n_processes
 * @return
 */
...
/**
 * get a vector with the displacements of each process as from possible split
 * @param vector
 * @param n_processes
 * @return
 */
...
/**
 * get the number of elements (rows x columns) that each process must calculating on result matrix
 * @param n_rows
 * @param n_columns
 * @param n_processes
 * @return
...
/**
 * get the displacements to access the initial position that each process is responsible
 * @param n_rows
 * @param n_columns
 * @param n_processes
 * @return
